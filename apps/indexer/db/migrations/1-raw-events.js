module.exports = class RawEvents00000000000001 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "set_fee" ("id" character varying NOT NULL, "market_id" text NOT NULL, "new_fee" numeric NOT NULL, "chain" integer NOT NULL, "block_number" integer NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_2fce55f7f2e7947fc3bae90f0fa" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "accrue_interest" ("id" character varying NOT NULL, "market_id" text NOT NULL, "prev_borrow_rate" numeric NOT NULL, "interest" numeric NOT NULL, "fee_shares" numeric NOT NULL, "chain" integer NOT NULL, "block_number" integer NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_d92f8cb36ae06782c560628535a" PRIMARY KEY ("id"))`)
